...
~,                 7,                 8,                 9,                 U_PIPE,            U_NA,              U_DF(U_BASE),      U_DF(U_EXTRA),     U_DF(U_TAP),       U_NA,              \
;,                 1,                 2,                 3,                 =,                 U_NA,              sft,               ctl,               alt,               met,               \
`,                 4,                 5,                 6,                 \\,                U_NA,              U_DF(U_NUM),       U_DF(U_NAV),       ralt,              U_NA,              \
...
!,                 @,                 #,                 $,                 %,                 U_NA,              U_DF(U_BASE),      U_DF(U_EXTRA),     U_DF(U_TAP),       U_NA,              \
[,                 ],                 U_LPRN,            U_RPRN,            +,                 U_NA,              sft,               ctl,               alt,               met,               \
^,                 &,                 {,                 },                 *,                 U_NA,              U_DF(U_SYM),       U_DF(U_MOUSE),     ralt,              U_NA,              \
U_NP,              U_NP,              :,                 #,                 \_,                U_NA,              U_NA,              U_NA,              U_NP,              U_NP
